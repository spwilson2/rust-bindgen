...
impl Builder {
    ...
    pub fn command_line_flags(&self) -> Vec<String> {
        ...
        if self.options.include_foundation {
            output_vector.push("--include-foundation".into());
        }
        if self.options.include_statement.is_some() {
            output_vector.push("--include-statement".into());
        }
    ...
    /// todo
    pub fn include_foundation(mut self, doit: bool) -> Self {
        self.options.include_foundation = doit;
        self
    }
    /// todo
    pub fn include_stement(mut self, statement: String) -> Self {
        self.options.include_statement = Some(statement);
        self
    }
...
struct BindgenOptions {
    ...
    include_statement: Option<String>,
